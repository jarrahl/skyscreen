...
/* "skyscreen_tools/flatspace_tools.pyx":28
 * 
 * # A wrapper for the c_polar_coord_transform below.
...
static PyObject *__pyx_pw_15skyscreen_tools_15flatspace_tools_3polar_coord_transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_angle)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("polar_coord_transform", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "polar_coord_transform") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("polar_coord_transform", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_15skyscreen_tools_15flatspace_tools_2polar_coord_transform(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_mag, PyObject *__pyx_v_angle) {
  ...
  /* "skyscreen_tools/flatspace_tools.pyx":30
 * def polar_coord_transform(mag, angle):
 * 	cdef int i_mag, i_angle
 * 	i_angle = angle             # <<<<<<<<<<<<<<
 * 	i_mag = mag
 * 	return c_polar_coord_transform(i_mag, i_angle)
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_angle); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_mag); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_i_mag = __pyx_t_1;

  /* "skyscreen_tools/flatspace_tools.pyx":32
 * 	i_angle = angle
 * 	i_mag = mag
 * 	return c_polar_coord_transform(i_mag, i_angle)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __pyx_convert__to_py___pyx_ctuple_int__and_int(__pyx_f_15skyscreen_tools_15flatspace_tools_c_polar_coord_transform(__pyx_v_i_mag, __pyx_v_i_angle)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static __pyx_ctuple_int__and_int __pyx_f_15skyscreen_tools_15flatspace_tools_c_polar_coord_transform(int __pyx_v_mag, int __pyx_v_angle) {
  ...
  /* "skyscreen_tools/flatspace_tools.pyx":36
 * cdef (int, int)c_polar_coord_transform(int mag, int angle):
 * 	cdef double d_angle, d_mag
 * 	d_angle = <double>angle             # <<<<<<<<<<<<<<
 * 	d_mag   = <double>mag
 ...
 */
  ...
  /* "skyscreen_tools/flatspace_tools.pyx":38
 * 	d_angle = <double>angle
 * 	d_mag   = <double>mag
 * 	row = <int>round(d_mag * sin(d_angle/360.0 * 2.0 * 3.14159265)) # Like Y             # <<<<<<<<<<<<<<
 * 	col = <int>round(d_mag * cos(d_angle/360.0 * 2.0 * 3.14159265)) # Like X
 ...
 * 	i_angle = angle
 */
  __pyx_tuple__9 = PyTuple_Pack(4, __pyx_n_s_mag, __pyx_n_s_angle, __pyx_n_s_i_mag, __pyx_n_s_i_angle); if (unlikely(!__pyx_tuple__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_riri_Documents_sky_screen, __pyx_n_s_polar_coord_transform, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_screen_max_magnitude); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 	i_angle = angle
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_15skyscreen_tools_15flatspace_tools_3polar_coord_transform, NULL, __pyx_n_s_skyscreen_tools_flatspace_tools); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_polar_coord_transform, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
